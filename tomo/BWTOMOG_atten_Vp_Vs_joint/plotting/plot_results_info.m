...
set(gca,'xlim',[0 360],'xtick',[0:45:360],'yaxislocation','right')
caxis([-1.5 1.5]);
title('Event static times','FontSize',16)
ylabel('ray-parameter','FontSize',14)
xlabel('baz','FontSize',14)

% map station terms
plot_sta_static(par,data,model)
...
% xlabel('Station static times','FontSize',16)
% caxis([-1.5 1.5])
...
if nargin == 6 && ~isempty(start_model)
    ...
    title('Event static errors','FontSize',16)
