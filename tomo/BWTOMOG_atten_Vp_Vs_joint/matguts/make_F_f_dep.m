function [ F,f,reso,data ] = make_F_f_dep( G,d,data,par,dep,direction )
...
%% H_damp
[H_damp,h_damp]  = make_dampmat_dep(data,par,dep,direction);
...
elseif par.build_smooth == 1
   [ H_smth ] = make_smoothmat_dep( par,dep,direction); 
